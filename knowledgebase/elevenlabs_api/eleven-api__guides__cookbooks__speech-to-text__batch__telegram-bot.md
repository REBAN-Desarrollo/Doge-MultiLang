...
subtitle: >-
Build a Telegram bot that transcribes audio and video messages in 90+languages
...
* The ElevenLabs [JavaScript SDK](/docs/developers/quickstart) to interact with the speech-to-text API.
